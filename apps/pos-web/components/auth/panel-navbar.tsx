...
export function PanelNavbar({
  ...
  return (
    <header
      className={`mz-shell-surface mz-panel-header sticky top-0 flex shrink-0 items-center gap-2 border-b border-mz-shell-border bg-mz-shell px-2 text-mz-shell-fg sm:px-3 ${className}`}
    ...
    >
      {hasNavigation && (
        <button
          ...
          title={isMobileOpen ? "Menyuni yopish" : "Menyuni ochish"}
