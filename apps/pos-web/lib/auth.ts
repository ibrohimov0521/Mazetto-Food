...
const customAdminRedirects = [
  ...
  { permission: "KITCHEN_VIEW", href: "/admin/kitchen-monitor" },
  { permission: "COURIER_MANAGE", href: "/admin/couriers" },
  { permission: "CUSTOMER_VIEW", href: "/admin/customers" },
  { permission: "MENU_VIEW", href: "/admin/products" },
  { permission: "HOMEPAGE_MANAGE", href: "/admin/homepage" },
  { permission: "BRANCH_VIEW", href: "/admin/branches" },
  { permission: "DEVICE_VIEW", href: "/admin/devices" },
  { permission: "RECEIPT_VIEW", href: "/admin/receipts" },
  { permission: "PAYMENT_VIEW", href: "/admin/payments" },
  { permission: "RECEIPT_PRINT", href: "/admin/printers" },
  { permission: "STAFF_VIEW", href: "/admin/staff" },
  { permission: "ROLE_VIEW", href: "/admin/roles" },
  { permission: "SHIFT_VIEW_BRANCH", href: "/admin/shifts" },
  ...
  { permission: "RECIPE_MANAGE", href: "/admin/recipes" },
