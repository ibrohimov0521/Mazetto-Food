 ...
 *
 * Nima uchun kerak: `.env` da `REDIS_PORT=6380` turibdi (6379 ni boshqa
 * loyihaning konteyneri egallagan) va `REDIS_URL` bo'sh. Faqat `REDIS_URL`
 * ga qaralsa kesh lokalda JIMGINA xotiraga tushib qolardi — ishlayotgandek
 * ko'rinib, aslida Redis'ga umuman ulanmasdan.
 */
