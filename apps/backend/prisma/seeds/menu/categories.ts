...
export const menuCategories: MenuCategorySeed[] = [
  {
    code: "LAVASH",
    name: "Lavashlar",
    description: "Mol go'shtli, tovuqli, pishloqli, achchiq va tandir lavashlar.",
  ...
  },
  {
    code: "BURGER",
    name: "Burgerlar",
    description: "Mol go'shtli va tovuqli burgerlar.",
  ...
  },
  {
    code: "HOT_DOG",
    name: "Hot Doglar",
    description: "Salatli, qazili, chicken va shashlikli hot doglar.",
  ...
  },
  {
    ...
    description: "Doner, klab senvich, xaggi va uy uslubidagi mahsulotlar.",
  ...
  },
  {
    code: "FAST_FOOD",
    name: "Gazaklar",
    description: "Fri, naggets, kurinniy sharik va boshqa gazaklar.",
