...
const roleDefinitions = [
  ...
  },
  {
    ...
    permissions: [
      ...
      PERMISSIONS.CASH_HANDOVER_FORCE,
...
const permissionNames: Record<string, string> = {
  ...
  [PERMISSIONS.STAFF_DELETE]: "Delete staff accounts",
  ...
  [PERMISSIONS.PAYMENT_REFUND]: "Refund completed cash payments",
  ...
  [PERMISSIONS.SHIFT_VIEW_OWN]: "View own employee cash shift",
  [PERMISSIONS.SHIFT_VIEW_BRANCH]: "View all shifts in branch",
  [PERMISSIONS.SHIFT_OPEN]: "Open employee cash shifts",
  [PERMISSIONS.SHIFT_CLOSE]: "Close employee cash shifts",
  [PERMISSIONS.CASH_TRANSACTION_CREATE]: "Create cash drawer transactions",
  [PERMISSIONS.CASH_HANDOVER_FORCE]: "Force and record cash handovers",
  [PERMISSIONS.CUSTOMER_VIEW]: "View customers",
  [PERMISSIONS.CUSTOMER_DELETE]: "Delete customers without order history",
